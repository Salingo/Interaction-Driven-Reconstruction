...
class SegLitModule(LightningModule):
    ...
    def __init__(
        ...
        self.train_start_seg_acc = Accuracy(task="binary")
        self.train_end_seg_acc = Accuracy(task="multiclass", num_classes=3)

        self.val_start_seg_acc = Accuracy(task="binary")
        self.val_end_seg_acc = Accuracy(task="multiclass", num_classes=3)

        self.test_start_seg_acc = Accuracy(task="binary")
    ...
    def model_step(self, batch: Any, visualize: bool = False, output=False):
        gt_start_xyz, gt_end_xyz, data, gt_start_seg, gt_end_seg, pid_list, data_path_list, joint_info = batch
    ...
    def validation_step(self, batch: Any, batch_idx: int):
        loss, pred_seg_start, \
            pred_seg_end, gt_start_seg, gt_end_seg = self.model_step(batch)
